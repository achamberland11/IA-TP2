...
GPlayerCharacter* GWorld::CreatePlayer()
{
    ...
    Controllers.push_back(player->GetController());return player;
}

void GWorld::CreateAgent(GPlayerCharacter* player)
{
    GAgentCharacter *agent = new GAgentCharacter();dynamic_cast<GAgentController*>(agent->GetController())->SetPlayer(player);
